    ...
    def post(self,request,  format= None):
        ...
        if serializer.is_valid():
            ...
            if queryset.exists():
                ...
                room.save(update_fields=['votesToSkip', 'guestCanPause'])
...
class GetRoom(APIView):
    ...
    def  get(self, request, format=None):
        ...
        if code!=None:
            ...
            return Response({'room not found':'room invalid'}, status=status.HTTP_404_NOT_FOUND)
    ...
    def put(self, request, format = None):
        ...
        if serializer.is_valid():
            ...
            if room.host != user_id :
                return Response({"msg":"you are not authorised "}, status=status.HTTP_403_FORBIDDEN)
